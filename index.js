...
function areDisjoint(set1, set2) {
  ...
  for (let element of set1) {
    // Якщо знайдено спільний елемент з другою множиною, використовуємо метод has для перевірки
    if (set2.has(element)) {
      // Повертаємо false, якщо є спільний елемент
      return false;
    }
  }
